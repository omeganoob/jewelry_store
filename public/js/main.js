...
$(document).ready(function() {
	...
	$("#price-range").slider({
		...
		slide: function( event, ui ) {
			$(".ui-slider-handle:first").html("<span>$" + ui.values[ 0 ] + "</span><input type='hidden' name='minprice' value='"+ ui.values[0] +"'></input>");
			$(".ui-slider-handle:last").html("<span>$" + ui.values[ 1 ] + "</span><input type='hidden' name='maxprice' value='"+ ui.values[1] +"'></input>");
		}
	});
