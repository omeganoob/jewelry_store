             ...
             <div class="best_main">
                <div class="row d_flex">
                   <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                      <div class="best_text">
                         <p>A reader will be distracted by the readable content of a page when looking at its layout. The point of using LoremIt is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem</p>
                         <a href="/product/show">See More</a>
                      </div>
                   </div>
                   <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                      <div class="best_img">
                         <h4>Best Design Of Ring</h4>
                         <figure><img src="{{ asset('storage/images/welcomepage/beimg.png') }}"></figure>
                      </div>
                   </div>
                </div>
             </div>
                ...
                <div class="row d_flex">
                   <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                      <div class="best_img croos_rt">
                         <h4>Best Design Of Ring</h4>
                         <figure><img src="{{ asset('storage/images/welcomepage/beimg2.png') }}"></figure>
                      </div>
                   </div>
                   <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                ...
                <div class="row d_flex">
                   ...
                   <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                      <div class="best_img d_none">
                         <h4>Best Design Of Ring</h4>
                         <figure><img src="{{ asset('storage/images/welcomepage/beimg3.png') }}"></figure>
                      </div>
                   </div>
                </div>
             </div>
    ...
    <div class="container">
       ...
       <div class="row">
          ...
          <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
             <div class="rable-box">
                <figure>
                <img src="{{ asset('storage/images/welcomepage/cac.png') }}" alt="#" />
             </div>
          </div>
       </div>
    </div>
                         ...
                         <div class="carousel-caption">
                            <div class="row d_flex">
                               <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 pa_rile">
                                  <div class="img_box">
                                     <i><img src="{{ asset('storage/images/welcomepage/icon_1.png') }}" alt="#"/></i>
                                     <figure><img src="{{ asset('storage/images/welcomepage/clients.png') }}" alt="#"/></figure>
                                  </div>
                               </div>
